        ...
        <ThemeProvider>
          <div className="flex h-full bg-gray-50">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              {/* Barra superior: recordatorios + atajo de búsqueda + selector de tema */}
              <header className="h-12 shrink-0 flex items-center justify-end gap-3 px-4 bg-white border-b border-gray-200">
                <RecordatorioBell />
