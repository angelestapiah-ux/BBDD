...
const CAPITULOS = [
  ...
  },
  {
    ...
    pasos: [
      ...
      { t: 'El semáforo compara plan contra realidad', d: 'Verde va en meta, amarillo va sobre el umbral de riesgo, rojo va bajo el umbral. El gris significa que aún queda por medir. Antes del 1 de septiembre, cuando la ventana del plan aún no abre, todas se ven grises "Por comenzar", así el gris se lee como "aún sin dato" y jamás como "vamos mal".' },
      ...
      { t: 'Carga las mediciones para encender el semáforo', d: 'El botón "Cargar mediciones" (arriba a la derecha) lleva a la pantalla de carga. Ahí, "Recalcular desde el CRM" refresca solo las metas que se calculan del propio CRM (ingresos, ventas y leads), y las de redes y plataformas se cargan a mano con el dato de cada panel. El valor real aparece en el árbol y enciende el color.' },
