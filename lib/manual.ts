...
export const MANUAL: EntradaManual[] = [
  {
    ...
    pasos: [
      ...
      'El "Tipo de cliente" son las actividades del catálogo: al asignar una, se registra automáticamente su asistencia en el perfil.',
  ...
  },
  {
    ...
    categoria: 'Pagos',
    keywords: 'registrar pago nuevo cobro abono monto factura transferencia sin cobro fecha actividad',
    pasos: [
      ...
      'Completa monto, fecha de pago y fecha de la actividad (si son distintas), método y estado.',
  ...
  },
  {
    ...
    tip: 'También puedes editar el pago completo desde el perfil del cliente, pestaña "Actividades y pagos", con el ícono de lápiz.',
  },
  {
