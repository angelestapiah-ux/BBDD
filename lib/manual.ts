...
export const MANUAL: EntradaManual[] = [
  ...
  },
  {
    ...
    categoria: 'Pagos',
    keywords: 'honorarios boleta docente terapeuta retencion sii liquido bruto emitir',
    pasos: [
      'Ve a "Honorarios" en el menú lateral.',
      'Automático (terapias): al registrar el pago de un paciente con terapeuta asignado, se crea sola una boleta "Pendiente" para ese terapeuta.',
      'Manual (clases): haz click en "Nueva boleta", busca al prestador en el listado de clientes (o escribe el nombre), y completa la glosa.',
      ...
      'Si el prestador es cliente, sus boletas aparecen también en su perfil (pestaña Honorarios).',
    ],
  },
  {
    id: 'gastos',
